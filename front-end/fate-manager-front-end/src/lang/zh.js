export const m = {
    ...
    welcome: {
        'activateSite': '激活站点',
        'confirmAndActivate': '确认激活',
        'activateSuccessfully': '激活成功 !',
        'beforeUsingModeling': '在使用联邦学习建模之前，您必须确保正确部署了 FATE。',
        'welcome': '欢迎来到FATE Cloud!',
        'introductions': '作为构建和管理联邦数据合作网络的基础设施，提供一站式联邦数据合作服务。',
        'administratorNotActivated': '管理员账号尚未激活？',
        'activateIt': '点此激活',
        'contactAdministratorTips': '请联系管理员为你添加权限',
        'RememberMe': '记住密码',
        'SignIn': '登录',
        'register': '注册',
        'userNameTips': '请输入 用户名/邮箱/手机',
        'passWordTips': '请输入密码',
        'correctAccountTips': '请输入正确的帐号',
        'notSupportChinese': '密码不支持中文字符',
        'startRegistering': '开始注册并加入一个联邦组织。',
        'afterJoining': '成功加入联邦组织后，您就可以进行联邦建模了。',
        'adminActivation': '管理员激活',
        'enterLinkTip': '请输入Cloud Manager 提供的管理员激活链接',
        'bindAccount': '请绑定一个管理员账号',
        'enterPasswordTip': '请输入密码',
        'invitationLinkRequired': '请输入激活链接',
