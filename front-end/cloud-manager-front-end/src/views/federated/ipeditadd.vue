      ...
      <div class="add-dialog-body">
        <div class="line-box">
          <div class="line"  @dblclick="getEdit(index)" v-for="(item, index) in entrancesSelect" :key="index" >
            ...
            :placeholder="`${$t('m.siteAdd.typeLike',{type:networkacesstype==='entrances' ? $t('m.ip.entrances') : $t('m.ip.exit')})}: 127.0.0.1:8080`" >
    ...
    methods: {
        ...
        saveAction() {
            ...
            if (parameterName) {
                ...
                this.$parent.$refs[`${this.formName}`].validateField(`${parameterName}`, valid => {})
...
@import 'src/styles/ipeditadd.scss';
</style>
