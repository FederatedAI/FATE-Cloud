...
def activate():
    ...
    detect_utils.check_config(config=request_data,required_arguments=['link', 'userName'])
    data = login_service.fate_manager_activate(request_data.get('link'), request_data.get('userName'))
