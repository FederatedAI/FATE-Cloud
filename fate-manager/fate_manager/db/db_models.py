...
from peewee import (CharField, IntegerField, BigIntegerField, SmallIntegerField,
                    TextField, CompositeKey, BigAutoField, AutoField, DateField)
...
class ApplySiteInfo(DataBaseModel):
    ...
    site_name = CharField(max_length=50, help_text='site name')
...
class FateSiteInfo(DataBaseModel):
    ...
    polling_status_new = SmallIntegerField(default=1, help_text='edit status,-1 unkonwn,1 unedit,2 edit')
    secure_status_new = SmallIntegerField(default=1, help_text='edit status,-1 unkonwn,1 unedit,2 edit')
