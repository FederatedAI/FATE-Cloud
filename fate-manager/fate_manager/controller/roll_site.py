...
from fate_manager.utils.format_str import format_string
...
def write_site_route(roll_site_ip, roll_site_port, roll_site_key, site_route, party_id,
    ...
    format_route_table = format_string(json.dumps(route_table))
    roll_site_actuator(roll_site_ip, roll_site_port, roll_site_key, format_route_table, party_id, "set_route_table",
                       overall_timeout=DEFAULT_GRPC_TIMEOUT)
