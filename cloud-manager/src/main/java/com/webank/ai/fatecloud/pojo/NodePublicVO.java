...
public class NodePublicVO implements Serializable {
    private static final long serialVersionUID = -5592389661933762947L;
    private byte code;
    ...
    public NodePublicVO(byte code, String description, String englishDescription) {
        this.code = code;
        this.description = description;
        this.englishDescription = englishDescription;
    }
    public NodePublicVO(StationInfo stationInfo) {
