...
public class DetectiveStatusVO implements Serializable {
    private static final long serialVersionUID = -7480083342651328494L;
    private byte code;
    private String description;
    private String englishDescription;

    public DetectiveStatusVO() {
    }

    public DetectiveStatusVO(byte code, String description, String englishDescription) {
        this.code = code;
        this.description = description;
        this.englishDescription = englishDescription;
    }
    public DetectiveStatusVO(StationInfo stationInfo) {
