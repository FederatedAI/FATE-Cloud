...
public class NodeStatusVO implements Serializable {
    private static final long serialVersionUID = -8074623284314452377L;
    private byte code;
    ...
    public NodeStatusVO(byte code, String description, String englishDescription) {
        this.code = code;
        this.description = description;
        this.englishDescription = englishDescription;
    }
    public NodeStatusVO(StationInfo stationInfo) {
